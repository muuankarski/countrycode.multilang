...
wiki_names$country.name.russian.fao[wiki_names$country.name.russian.fao == "Республика Македония"] <- "Бывшая югославская Республика Македония"
...
wiki_names$country.name.russian.fao[wiki_names$country.name.russian.fao == "Молдавия"] <- "Республика Молдова"
...
wiki_names$country.name.russian.fao[wiki_names$country.name.russian.fao == "Великобритания"] <- "Соединенное Королевство Великобритании и Северной Ирландии"
...
wiki_names$country.name.russian.fao[wiki_names$country.name.russian.fao == "Чехия"] <- "Чешская Республика"
